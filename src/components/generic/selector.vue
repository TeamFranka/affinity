<template>
  ...
  <ion-popover :is-open="showPopover"  :event="event">
    <div class="ion-padding">
      ...
      <slot name="item" v-for="item in items" :key="item" :item="item" :select="selectItem"></slot>
    </div>
  </ion-popover>
</template>
<script>
import {
  IonIcon, IonButton, IonPopover, IonTitle, IonLabel,
} from '@ionic/vue';
...
export default defineComponent({
  ...
  components: {
    IonPopover, IonIcon, IonButton, IonTitle, IonLabel
  },
  methods: {
    selectItem(item) {
