<template>
  <ul>
    <li v-for="l in items" :key="l.target">
      <a :href="l.target" target="_blank">
        <ion-icon v-if="showIcon" :icon="getSocialIcon(l.platform)" />
...
import {
  logoWhatsapp, logoTwitter, logoSoundcloud,
...
export const DefaultIcon: any = globeOutline;
