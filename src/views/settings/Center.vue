  ...
  <ion-page>
    <ion-content>
        <ion-list>
          ...
          <ion-item button v-if="hasPush" @click="$router.push({name: 'SettingsNotifications'})">
...
<script lang="ts">
import {
  IonContent, IonPage, IonList, IonListHeader, IonItem, IonIcon,
} from '@ionic/vue';
import {
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      generalIcon, notificationIcon,
    }
  },
  components: {
    IonPage, IonContent,  IonList, IonListHeader, IonItem, IonIcon,
  }
});
</script>