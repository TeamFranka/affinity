...
describe('Notification Configuration', () => {
  ...
  it('anon mobile can disable notifications', () => {
    ...
    const setup =  {isMobile: true, device: {
        "deviceName": "iPhone 6",
        "deviceModel": "as-asdf",
    ...
    cy.get('ion-item[data-cy-channel=news] ion-toggle').should("have.attr", "aria-checked", "false");
    cy.get('ion-item[data-cy-channel=notifications] ion-toggle').should("have.attr", "aria-checked", "false");
    cy.get('ion-item[data-cy-channel=notifications] ion-toggle').click();
    cy.get('ion-item[data-cy-channel=notifications] ion-toggle').should("have.attr", "aria-checked", "true");
